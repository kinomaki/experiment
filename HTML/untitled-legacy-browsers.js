...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'stimuli/ii_neu_min.png', 'path': 'stimuli/ii_neu_min.png'},
    {'name': 'stimuli/ii_poz_min.png', 'path': 'stimuli/ii_poz_min.png'},
    {'name': 'stimuli/ii_neg_min.png', 'path': 'stimuli/ii_neg_min.png'},
    ...
    {'name': 'stimuli/ii_neu_mid.png', 'path': 'stimuli/ii_neu_mid.png'},
    {'name': 'stimuli/ii_poz_mid.png', 'path': 'stimuli/ii_poz_mid.png'},
    {'name': 'stimuli/ii_neg_mid.png', 'path': 'stimuli/ii_neg_mid.png'},
    ...
    {'name': 'stimuli/ii_neu_max.png', 'path': 'stimuli/ii_neu_max.png'},
    {'name': 'stimuli/ii_poz_max.png', 'path': 'stimuli/ii_poz_max.png'},
    {'name': 'stimuli/ii_neg_max.png', 'path': 'stimuli/ii_neg_max.png'},
...
function trialRoutineBegin(snapshot) {
  return async function () {
    ...
    if ((stimLoop.thisN === 9)) {
        ...
        group_num = selected_groups[idx];
        group_rows = function () {
        var _pj_a = [], _pj_b = all_conditions;
        for (var _pj_c = 0, _pj_d = _pj_b.length; (_pj_c < _pj_d); _pj_c += 1) {
            var r = _pj_b[_pj_c];
            if ((r["group"] === group_num)) {
                _pj_a.push(r);
            }
        }
        return _pj_a;
    ...
    .call(this);
        chosen_row = Math.random.choice(group_rows);
...
function trialRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData("theme", theme);
    psychoJS.experiment.addData("tone", tone);
    psychoJS.experiment.addData("likes", likes);
    psychoJS.experiment.addData("image_shown", image);
    psychoJS.experiment.addData("useful", ((_pj.in_es6("useful", locals()) && (useful.getRating() !== null)) ? useful.getRating() : "NA"));
    psychoJS.experiment.addData("cred", ((_pj.in_es6("cred", locals()) && (cred.getRating() !== null)) ? cred.getRating() : "NA"));
    psychoJS.experiment.addData("share", ((_pj.in_es6("share", locals()) && (share.getRating() !== null)) ? share.getRating() : "NA"));
